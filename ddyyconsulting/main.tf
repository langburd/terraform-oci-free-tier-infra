...
module "dev_compartment" {
  source = "git@github.com:langburd/terraform-oci-free-tier-modules.git//oci/identity?ref=v1.0.1"
...
module "dev_budget" {
  source = "git@github.com:langburd/terraform-oci-free-tier-modules.git//oci/budget?ref=v1.0.1"
